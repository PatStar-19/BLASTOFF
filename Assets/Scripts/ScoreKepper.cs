...
public class ScoreKepper : MonoBehaviour
{
    ...
    public void Score(int points)
    {
        ...
        if (score >= 3000 && !hasReachedTargetScore)
        {
    ...
    private IEnumerator ExplodeEnemiesAndFlyPlayer()
    {
        ...
        {
            completionText.text = "Stage 1 Complete";
        ...
        {
            Debug.LogError("Player object is not assigned in the ScoreKepper script.");
        }
    }
    ...
    private void LoadNextScene()
    {
        ...
        // For example, load the scene with build index 4
